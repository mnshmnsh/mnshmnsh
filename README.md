...
Implementation of Carney & Varcoe’s *Universal Statistical Simulator*, reproducing classical and quantum Galton-board distributions using quantum circuits. Includes noise modeling, IBM hardware results, and error-mitigation experiments.
